<?php
	...
	//Lay bien controller tu url, sau do gan chuoi vao de no thanh mot duong dan file controller hoan chinh
	// -> Load file do vao day
	$controller = isset($_GET["controller"]) ? $_GET["controller"] : "";
	// gan them chu Controller vai bien $controller
	$className = $controller . "Controller";
	//$className = UsersController
	//viet hoa chu dau tien.VD: users -> Users
	$controller = ucfirst($controller);
	//$controller = "Users"
	//ghep cac gia tri de thanh duong dan hoan chinh den file controler
	...
	//$action = Read
	//kiem tra xem file co ton tai khong, neu co ton tai thi load vao day
