        ...
        <div class="panel-body">
				...
				<?php foreach ($listRecord as $rows): ?>
                    <tr>
                        ...
                        <td style="text-align:center;">
                            ...
                            <a href="index.php?controller=categories&action=delete&id=<?php echo $rows->id; ?>"
                               onclick="return window.confirm('Are you sure?');">Delete</a>
                        </td>
                    </tr>
					<?php
					// lay cac danh muc cap 1(cap con cua cap dau tien)
					$listSubRecord = $this->modelReatSub($rows->id);
					?>
            ...
            <ul class="pagination">
				...
				<?php for ($i = 1; $i <= $numPage; $i++): ?>
                    <li class="pape-item"><a href="index.php?controller=categories&action=read&p=<?php echo $i; ?>" class="pape-link"><?php echo $i; ?></a></li>
				<?php endfor; ?>
