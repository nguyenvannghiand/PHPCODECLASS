			...
			<div class="clearfix">
				...
				<div class="col-xs-6 col-md-3 col-sm-6 " style="height: 350px; overflow: hidden;">
					<div class="product-grid" id="product-1168979">
						...
						<div class="info">
							<h3 class="name"><a href="/Product/Detail/10">Samsung Galaxy S10</a></h3>
							<p class="price-box">
							...
							<div class="action-btn">
								<form action="cart/add" method="post" enctype="multipart/form-data" id="product-actions-1168979">
									<a href="index.php?controller=cart&action=add&id=<?php echo $rows->id;?>" class="button">Cho vào giỏ hàng</a>
								</form>
							</div>
						</div>
					</div>
				...
				<div class="&#x70;&#x61;&#x67;&#x69;&#x6E;&#x61;&#x74;&#x69;&#x6F;&#x6E;&#x2D;&#x63;&#x6F;&#x6E;&#x74;&#x61;&#x69;&#x6E;&#x65;&#x72;">
					<ul class="&#x70;&#x61;&#x67;&#x69;&#x6E;&#x61;&#x74;&#x69;&#x6F;&#x6E;">
						...
						<?php for ($i = 1;$i <= $numPape; $i++):?>
						<li><a href="index.php?controller=products&action=catefory&id=<?php echo $category_id;?>"><?php echo $i;?></a></li>
						<?php endfor;?>
					</ul>
				</div>
				<!-- end paging -->
